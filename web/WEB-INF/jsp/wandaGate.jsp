<%-- 
    Document   : wandaGate
    Created on : 23/10/2021, 19:43:22
    Author     : EXO
--%>
            ...
            <div class="card border-dark"> 
                <div class="card-body bg-dark text-white">
                    <table class="table table-hover">
                        ...
                        <thead>
                            <tr>
                                <th style="font-family: cursive" class="text-white">ID_PROTAGONISTA</th>
                                ...
                                <th style="font-family: cursive" class="text-white">ESCÁNDALO</th>
                        ...
                        <tbody>
                            <c:forEach var="dato" items="${lista}">
                                <tr>
                                    ...
                                    <td>
                                        <a href="escandalo.htm?id=${dato.id}"  style="font-family: cursive" class="btn btn-danger text-white">VER</a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </tbody>
